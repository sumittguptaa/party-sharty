    ...
    <div>
      <div className="body-login">
        <div className="header-login">
          <div style={{ marginLeft: "1rem" }} onClick={onClose}>
            <p>&#10006;</p>
          </div>
          <div>
            <p
            ...
            <div className="country-isd" style={{ display: "flex" }}>
              ...
              <div>
                <img
                  ...
                  src="/images/free-arrow-down-icon-3101-thumb-removebg-preview.png"
                  height="19rem"
                  width="19rem"
                  alt=""
                  style={{ marginLeft: "23.5rem", marginTop: "0.7rem" }}
                  onClick={() => {}}
                />
              </div>
            </div>
